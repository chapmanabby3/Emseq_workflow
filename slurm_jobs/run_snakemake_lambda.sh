...
snakemake --use-singularity \
    ...
    --cluster-generic-submit-cmd "sbatch --account=nn12038k --parsable --output=logs/slurm/slurm-%j.out --error=logs/slurm/slurm-%j.err --mem={resources.mem_mb} --cpus-per-task={threads} --time=04:00:00" \
